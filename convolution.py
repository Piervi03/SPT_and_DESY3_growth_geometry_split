...
def convolve_HMF_2obs_fixedkernel(dN_dlnM, Delta_lnM, kernel, Nbins_0, Nbins_1):
    ...
    res_out = Delta_lnM**2 * res[Nbins_0[0]:-Nbins_0[1], Nbins_1[0]:-Nbins_1[1]]
    return res_out
...
def convolve_HMF_3obs_fixedkernel(dN_dlnM, Delta_lnM, kernel, Nbins_0, Nbins_1, Nbins_2):
    ...
    res_out = Delta_lnM**3 * res[Nbins_0[0]:-Nbins_0[1], Nbins_1[0]:-Nbins_1[1], Nbins_2[0]:-Nbins_2[1]]
    return res_out
...
def convolve_HMF_2obs_varkernel(dN_dlnM, Delta_lnM, kernels, Nbins_0, Nbins_1):
    ...
    # Remove padding
    res_out = Delta_lnM**2 * res[pad_0_lo:-pad_0_hi, pad_1_lo:-pad_1_hi]
    return res_out
...
def convolve_HMF_3obs_varkernel(dN_dlnM, Delta_lnM, kernels, Nbins_0, Nbins_1, Nbins_2):
    ...
    # Remove padding
    res_out = Delta_lnM**3 * res[pad_0_lo:-pad_0_hi, pad_1_lo:-pad_1_hi, pad_2_lo:-pad_2_hi]
    return res_out
