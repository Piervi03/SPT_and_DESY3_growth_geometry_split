...
You can start by taking a look at the three `.yaml` files.

The entire code is pure python and has no fancy dependencies (except for
    Collossus for the Diemer&Kravtsov'15 concentration-mass relation).
